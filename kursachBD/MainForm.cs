    ...
    public partial class MainForm : Form
    {
        ...
        private void ConnectButton_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                MessageBox.Show("Подключение к базе произошло успешно.", "Успешное подключение", MessageBoxButtons.OK, MessageBoxIcon.Information);
            }
            catch(Exception ex)
            {
        ...
        private void CreateProcedureButton_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                con.Open();
                cmd.ExecuteNonQuery();
                MessageBox.Show("Процедура успешно создана в базе данных.", "Успешное создание процедуры", MessageBoxButtons.OK, MessageBoxIcon.Information);
            }
            catch (Exception ex)
            {
                MessageBox.Show(ex.Message, "Ошибка", MessageBoxButtons.OK, MessageBoxIcon.Error);
        ...
        private void CreateTriggerButton_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                con.Open();
                cmd.ExecuteNonQuery();
                MessageBox.Show("Триггер успешно создан в базе данных.", "Успешное создание триггера", MessageBoxButtons.OK, MessageBoxIcon.Information);
            }
            catch (Exception ex)
            {
                MessageBox.Show(ex.Message, "Ошибка", MessageBoxButtons.OK, MessageBoxIcon.Error);
        ...
        private void CreateDataBaseButton_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                con.Open();
                cmd.ExecuteNonQuery();
                MessageBox.Show("Таблицы успешно созданы.", "Успешное создание таблиц", MessageBoxButtons.OK, MessageBoxIcon.Information);
            }
            catch (Exception ex)
            {
                MessageBox.Show(ex.Message, "Ошибка", MessageBoxButtons.OK, MessageBoxIcon.Error);
        ...
        private void LoadDataInTableButton_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                con.Open();
                cmd.ExecuteNonQuery();
                MessageBox.Show("Строки успешно созданы.", "Успешное создание строк", MessageBoxButtons.OK, MessageBoxIcon.Information);
            }
            catch (Exception ex)
            {
                MessageBox.Show(ex.Message, "Ошибка", MessageBoxButtons.OK, MessageBoxIcon.Error);
